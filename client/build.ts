...
// Build CSS used by SSR pages.
console.log("🎨 Building SSR CSS...");
await Bun.$`bun run css:build`;

let result: Awaited<ReturnType<typeof build>> | null = null;

if (existsSync("src")) {
  // Legacy mode: projects with src/*.html entrypoints.
  ...
  console.log("ℹ️ No src/*.html entrypoints found in this workspace layout. Skipping Bun browser bundle.");
}
